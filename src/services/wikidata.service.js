...
const wdService = function($http, $q, langService) {
  ...
  function get(data) {
    ...
    return $http
      .jsonp('https://www.wikidata.org/w/api.php', {
  ...
  function getSearch(text, lang) {
    return get({
      action: 'wbsearchentities',
      search: text,
      type: 'item',
      language: lang || defaultParams.languages[0],
      uselang: lang || defaultParams.languages[0],
...
export default () => {
  angular.module('monumental').factory('wikidata', wdService);
};
